...
<div class="lounge-wrap">
  <div class="lounge-bg">
    ...
    <div class="lounge-neon">
      <div class="neon-text">🌿 BEEPBOP'S LOUNGE</div>
...
function startBubbles() {
  ...
  function addBubble() {
    ...
    b.style.cssText = [
      ...
      'height:'+size+'px',
      'border-radius:50%',
      'border:1.5px solid rgba(135,206,235,0.6)',
      'background:rgba(135,206,235,0.08)',
      'animation:bubble-rise '+(3+Math.random()*4)+'s ease-in forwards',
      'animation-delay:'+(Math.random()*2)+'s',
    ].join(';');
    wrap.appendChild(b);
    setTimeout(function(){b.remove();}, 7000);
  }
  setInterval(addBubble, 500);
}
...
<div class="lounge-player" id="lounge-player">
  ...
  <div class="lp-info">
    <div class="lp-track" id="lp-track">Sun Is Shining</div>
    <div class="lp-artist">🌿 Bob Marley Vibes</div>
  </div>
  ...
  el.insertAdjacentHTML('beforeend', playerHtml);
