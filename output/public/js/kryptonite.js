...
var KRYPTONITE_DATA = [
  ...
  { team:'DET', name:'Pistons',  color:'#C8102E',
    weakness:'Rebuilt defense is legit — 8th in DRTG. PFs & Cs still exploitable in post but perimeter D is top-10. Without Cade, offense struggles but D holds.',
    pts:{PG:19.8,SG:20.4,SF:21.1,PF:22.4,C:17.2},
    reb:{PG:3.4,SG:4.1,SF:6.2,PF:10.8,C:14.1},
    ast:{PG:6.4,SG:3.6,SF:3.4,PF:2.9,C:2.2},
    threes:{PG:2.6,SG:2.8,SF:2.4,PF:1.6,C:0.3},
    tags:['Improved D','PF Post Ups','No Cade = Less Offense','C Rebounds'],
    bestBet:'PF Points Over, C Rebounds Over — target the paint' },
